...
LOG_FILENAME_PREFIX = 'telegram-post'
...
MODULE_LOG_LEVELS = {
    'telegram_post': LOG_LEVEL,
    'telegram_post.collectors': LOG_LEVEL,
    'telegram_post.database': LOG_LEVEL,
    'telegram_post.analyze': LOG_LEVEL,
}
